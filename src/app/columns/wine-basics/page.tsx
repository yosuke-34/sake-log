    ...
    <div className="prose prose-sm max-w-none text-foreground">
      ...
      <div className="space-y-8 text-sm leading-relaxed">
        ...
        <section>
          ...
          <p className="text-muted mb-3">
            ワインは世界で数万銘柄が流通しています。ここでは初心者がまず押さえておきたい「定番銘柄」と、
            ワイン愛好家が憧れる「プレミアム銘柄」を紹介します。地球上で最も価格幅が広いお酒の一つです。
          </p>

          <h4 className="font-bold text-sm mb-2" style={{ color: '#A52D35' }}>📚 定番・入手しやすい銘柄</h4>
          <p className="text-xs text-muted mb-2">スーパー・コンビニ・量販店で広く流通する、デイリーワインの鉄板。</p>
          <div className="space-y-2 mb-5">
            {[
              { name: 'メルシャン ビストロ（日本）', desc: 'コンビニ・スーパー定番。500円〜1,000円台で世界各地の品種を手軽に楽しめる入門ライン。' },
              { name: 'コノスル ビシクレタ（チリ）', desc: '自転車のラベルでお馴染み。1,000円前後で本格的な味わい、コスパランキング常連。' },
              { name: 'モンテス・アルファ（チリ）', desc: '1,500〜2,500円帯のチリ高品質ワインの代表。カベルネ・シャルドネ・ピノ等揃う。' },
              { name: 'ハーディーズ（オーストラリア）', desc: '1,000円台のシラーズが甘い果実味で人気。コンビニでも入手可能。' },
              { name: 'カステッロ・バンフィ（イタリア）', desc: 'イタリア・トスカーナの大手。「キャンティ」「サンタンジェロ」など2,000円前後の銘柄が世界中で支持されている。' },
              { name: 'シャブリ・ドメーヌ ウィリアム・フェーヴル（仏）', desc: 'シャブリの代表的生産者。3,000円台で本物のシャブリを体験できる。' },
              { name: 'モエ・エ・シャンドン（仏・シャンパーニュ）', desc: '世界で最も売れているシャンパン。「ブリュット アンペリアル」が定番、6,000円前後。' },
          ...
          <p className="text-xs text-muted mb-2">ワインショップでよく出会う、好みを探る中級者向けの銘柄。</p>
          <div className="space-y-2 mb-5">
            {[
              { name: 'シャトー・モンペラ（仏・ボルドー）', desc: '映画『神の雫』で有名になった、ボルドー右岸の「コスパ最強」の代名詞。3,000円台。' },
              { name: 'シャトー・タルボ（仏・ボルドー）', desc: 'サン・ジュリアン格付け4級。長期熟成にも耐える、ボルドー入門にお勧め。8,000円〜。' },
              { name: 'ティニャネロ（伊・トスカーナ）', desc: 'スーパータスカンの先駆け。トスカーナの伝統と国際品種の融合。10,000円前後。' },
              { name: 'ガヤ（伊・ピエモンテ）', desc: 'バルバレスコの巨匠。「DOCG」格付けの最高峰の一つ。1〜数万円。' },
              { name: 'プニャネッロ（伊・トスカーナ）', desc: 'リーズナブルなスーパータスカン。3,000円台でイタリアらしさを体験できる。' },
              { name: 'ペンフォールズ Bin 389（豪）', desc: '「貧者のグランジ」と呼ばれるオーストラリア代表ワイン。6,000円台。' },
              { name: 'リッジ モンテベロ（米）', desc: 'カリフォルニアの伝統的ボルドーブレンド。世界的に評価高。' },
          ...
          <p className="text-xs text-muted mb-2">世界的に伝説となっている超高級ワイン。一度は名前を知っておきたい銘柄。</p>
          <div className="space-y-2 mb-3">
            {[
              { name: 'ロマネ・コンティ（ドメーヌ・ド・ラ・ロマネ・コンティ／DRC）', desc: 'ブルゴーニュの「神の酒」。年間生産量わずか6,000本前後。1本300〜500万円の世界最高峰ピノ・ノワール。' },
              { name: 'シャトー・ペトリュス（仏・ポムロール）', desc: 'メルロー主体のボルドー最高峰。1本30〜100万円。映画にも度々登場。' },
              { name: 'シャトー・ル・パン（仏・ポムロール）', desc: 'ペトリュスと並ぶポムロールの神話的ワイン。年間生産わずか6,000本。1本50〜150万円。' },
              { name: 'シャトー・ラトゥール / マルゴー / ラフィット / ムートン / オー・ブリオン（仏・5大シャトー）', desc: 'ボルドー左岸格付け1級（プルミエ・グラン・クリュ）の5銘柄。1本5〜30万円。' },
              { name: 'ドメーヌ・ルロワ（仏・ブルゴーニュ）', desc: 'ビオディナミ農法の女王・マダム・ルロワの極上ピノ。グラン・クリュは1本30〜100万円。' },
              { name: 'スクリーミング・イーグル（米・ナパヴァレー）', desc: 'カルトワイン（カルト的人気で生産量が極小）の頂点。1本100〜300万円。' },
              { name: 'サッシカイア（伊・ボルゲリ）', desc: 'スーパータスカンの最高峰。「イタリアのラフィット」と称される。3〜10万円。' },
              { name: 'オーパス・ワン（米／仏 合作）', desc: 'ロバート・モンダヴィとシャトー・ムートン・ロートシルトの共同プロジェクト。3〜5万円。' },
              { name: 'クリュッグ クロ・デュ・メニル / クロ・ダンボネ（仏・シャンパーニュ）', desc: '単一畑シャンパーニュの最高峰。10〜30万円。' },
              { name: 'シャトー・ディケム（仏・ソーテルヌ）', desc: '世界最高峰の貴腐ワイン。50年以上熟成可能。1本5〜20万円。' },
            ].map((b) => (
          ...
          <p className="text-[11px] text-muted">
            ※ 価格・流通は2026年時点の参考相場です。プレミアムワインは投資対象にもなっており、ヴィンテージ・状態・産地で価格が大きく変動します。
            グラスワインで提供している高級レストラン・ワインバーで少量試すのが、賢明なアプローチです。
          </p>
        </section>
